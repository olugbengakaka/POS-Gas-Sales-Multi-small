        ...
        private void button3_Click(object sender, EventArgs e)
        {
                ...
                if (dr27 == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        gclass.display_in_dgv_online("SELECT* FROM table_sales_confirmed WHERE Day='" + date.Value.Day + "' AND Month='" + date.Value.Month + "' AND Year='" + date.Value.Year + "' and branch='" + branch.Text + "'", dataGridView2, str200);

                        // SYNCHRONIZATION FOR DAILY METER READING IN KG ************************************************************8
                        if (daily_meter_reading.Checked == true)
                            {
                                gclass.display_in_dgv_online("SELECT* FROM TABLE_CLOSING_STOCK_GAS where Day='" + date.Value.Day + "' AND Month='" + date.Value.Month + "' AND Year='" + date.Value.Year + "' AND branch='" + branch.Text + "'", dataGridView1,str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_sales WHERE Day='" + date.Value.Day + "' AND Month='" + date.Value.Month + "' AND Year='" + date.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                                ...
                                gclass.display_in_dgv_online("SELECT* FROM table_sales_confirmed WHERE Day='" + date.Value.Day + "' AND Month='" + date.Value.Month + "' AND Year='" + date.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                                ...
                                gclass.display_in_dgv_online("SELECT* FROM table_sales_lump WHERE Day='" + date.Value.Day + "' AND Month='" + date.Value.Month + "' AND Year='" + date.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                                ...
                                gclass.display_in_dgv_online("SELECT* FROM table_repayment WHERE Day='" + date.Value.Day + "' AND Month='" + date.Value.Month + "' AND Year='" + date.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_expenditure WHERE Day='" + date.Value.Day + "' AND Month='" + date.Value.Month + "' AND Year='" + date.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_stock_inventory WHERE Day='" + date.Value.Day + "' AND Month='" + date.Value.Month + "' AND Year='" + date.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                                ...
                                gclass.display_in_dgv_online("SELECT* FROM table_stock_inventory_summary WHERE Day='" + date.Value.Day + "' AND Month='" + date.Value.Month + "' AND Year='" + date.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_buyers WHERE Day='" + date.Value.Day + "' AND Month='" + date.Value.Month + "' AND Year='" + date.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
                            ...
                            {
                                gclass.display_in_dgv_online("SELECT* FROM table_in WHERE Day='" + date.Value.Day + "' AND Month='" + date.Value.Month + "' AND Year='" + date.Value.Year + "' and branch='" + branch.Text + "'", dataGridView1, str200);
